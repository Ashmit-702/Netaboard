    ...
    <div className="card" style={{ maxWidth: 380 }}>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <svg width="260" height="150" viewBox="0 0 260 150">
          <path d="M20,140 A110,110 0 0,1 240,140" fill="none" stroke="#e9e1cd" strokeWidth="18" strokeLinecap="round" />
          <path
            ref={arcRef}
          ...
          />
          <text x="130" y="112" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="34" fontWeight="700" fill="#211c14">
            {display}%
          </text>
          <text x="130" y="132" textAnchor="middle" fontFamily="Inter" fontSize="11" fill="#6b6252">
