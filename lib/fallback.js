...
// The Constituency feature was removed from the product (database only
// held 2 historical Bihar seats — not enough to be meaningful). No
// fallback needed.

// Illustrative attention snapshots — used only when Supabase isn't
// configured. Real politicians, plausible numbers, but NOT live data.
export const fallbackAttention = [
  { name: "Narendra Modi", slug: "narendra-modi", role: "Prime Minister of India", score: 187.4, change_pct: 3.1, reason: "142 mentions in the last 24h (wikipedia_pageviews:89, gdelt_articles:31, hackernews:4, mastodon:18)" },
  { name: "Nitish Kumar", slug: "nitish-kumar", role: "Chief Minister, Bihar", score: 92.1, change_pct: -1.4, reason: "58 mentions in the last 24h (wikipedia_pageviews:22, gdelt_articles:19, mastodon:17)" },
  { name: "Tejashwi Yadav", slug: "tejashwi-yadav", role: "Leader of Opposition, Bihar", score: 104.6, change_pct: 4.2, reason: "76 mentions in the last 24h (wikipedia_pageviews:31, gdelt_articles:28, hackernews:2, mastodon:15)" },
  { name: "Rahul Gandhi", slug: "rahul-gandhi", role: "Leader of Opposition, Lok Sabha", score: 78.3, change_pct: -0.6, reason: "49 mentions in the last 24h (wikipedia_pageviews:20, gdelt_articles:24, mastodon:5)" },
];
...
export function fallbackChanges() {
  ...
  const changes = [
    ...
    },
    {
      ...
      sources: [], timestamp: "2026-08-19T06:00:00Z", confidence: null, href: "/attention",
    },
    {
